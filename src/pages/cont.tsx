...
export default function ContactPage() {
   return (
      <section className='h-screen w-full flex flex-col items-center justify-between'>
         ...
         <section className='bg-[#CCE7D0] sm:w-3/4 mx-auto rounded w-[95%] sm:mt-[10%] shadow sm:flex-row flex flex-col items-center'>
            <div className='flex flex-col items-start justify-end w-full sm:p-7 p-5'>
            ...
            <div className='flex flex-col items-center w-full gap-10 pl-10 sm:border-l-2 pb-10 p-3 border-green-900 h-3/5'>
